...
- [ ] **GitHub Pages** is enabled: **Settings → Pages →** deploy from branch **gh-pages** (root). Required for the repository URL to work.
...
- [ ] Confirm **gh-pages** branch has `manifest.json` (e.g. open `https://jokroese.github.io/jellyfin-upload-inbox/manifest.json`).
